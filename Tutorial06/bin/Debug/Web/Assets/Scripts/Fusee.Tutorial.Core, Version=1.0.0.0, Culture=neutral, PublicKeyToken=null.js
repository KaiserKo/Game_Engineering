...
(function Renderer$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm14.System.Collections.Generic.Dictionary$b2.Of($asm14.System.String, $asm03.Fusee.Engine.Common.ITexture))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm14.System.Collections.Generic.Dictionary$b2.Of($asm14.System.String, $asm04.Fusee.Engine.Core.ShaderEffect))) ();
  };
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm04.Fusee.Engine.Core.RenderContext)) ();
  };
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm14.System.Collections.Generic.Dictionary$b2.Of($asm07.Fusee.Serialization.MeshComponent, $asm04.Fusee.Engine.Core.Mesh))) ();
  };
  var $T04 = function () {
  ...
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm01.Fusee.Base.Core.Diagnostics)) ();
  };
  var $T09 = function () {
  ...
  var $T14 = function () {
    return ($T14 = JSIL.Memoize($asm06.Fusee.Math.Core.float2)) ();
  };
  var $T15 = function () {
  ...
  var $T17 = function () {
    return ($T17 = JSIL.Memoize($asm06.Fusee.Math.Core.float4x4)) ();
  };
  var $T18 = function () {
  ...
  var $T1B = function () {
    return ($T1B = JSIL.Memoize($asm07.Fusee.Serialization.MaterialComponent)) ();
  };
  var $T1C = function () {
  ...
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm14.TypeRef("System.Collections.Generic.Dictionary`2", [$asm14.TypeRef("System.String"), $asm03.TypeRef("Fusee.Engine.Common.ITexture")]), null))) ();
  };
  var $S01 = function () {
  ...
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.ConstructorSignature($asm14.TypeRef("System.Collections.Generic.Dictionary`2", [$asm07.TypeRef("Fusee.Serialization.MeshComponent"), $asm04.TypeRef("Fusee.Engine.Core.Mesh")]), null))) ();
  };
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.MethodSignature($asm06.TypeRef("Fusee.Math.Core.float2"), [$asm06.TypeRef("Fusee.Math.Core.float2"), $asm14.TypeRef("System.Single")]))) ();
  };
  var $S04 = function () {
  ...
  function Renderer__ctor (rc) {
    this._meshes = $S02().Construct();
    this._model = new ($T04())(4);
    $T05().prototype._ctor.call(this);
    this.RC = rc;
    $thisType.addToTextureDictionary("Leaves.jpg", $thisType.createTexture("Leaves.jpg", this.RC));
    $thisType.addToTextureDictionary("Treetex.jpg", $thisType.createTexture("portrait.jpg", this.RC));
    this.standardTex = $thisType.textures.get_Item("Leaves.jpg");
    this.standardTreeTex = $thisType.textures.get_Item("Treetex.jpg");
    this.stdVertexShader = $T07().Get$b1($T06())("VertexShader.vert");
    this.stdPixelShader = $T07().Get$b1($T06())("PixelShader.frag");
    this.toonVertexShader = $T07().Get$b1($T06())("VertexShaderOutline.vert");
    this.toonPixelShader = $T07().Get$b1($T06())("PixelShaderOutline.frag");
    this.cellVertexShader = $T07().Get$b1($T06())("VertexShader2.vert");
    this.cellPixelShader = $T07().Get$b1($T06())("PixelShader2.frag");
    $T08().Log($thisType.textures);
    var expr_F7 = JSIL.Array.New($T0A(), 1);
    var effectPassDeclaration = new ($T0A())();
    effectPassDeclaration.VS = this.stdVertexShader;
    effectPassDeclaration.PS = this.stdPixelShader;
    var expr_122 = new ($T0B())();
    expr_122.set_ZEnable(true);
    expr_122.set_CullMode($T0C().Counterclockwise);
    effectPassDeclaration.StateSet = expr_122;
    expr_F7[0] = effectPassDeclaration.MemberwiseClone();
    var expr_143 = JSIL.Array.New($T0E(), 7);
    ...
    expr_143[0] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "shininess";
    effectParameterDeclaration.Value = $T10().$Box(1);
    expr_143[1] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "specfactor";
    effectParameterDeclaration.Value = $T10().$Box(1);
    expr_143[2] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "speccolor";
    effectParameterDeclaration.Value = $T0F().Zero.MemberwiseClone();
    expr_143[3] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "ambientcolor";
    effectParameterDeclaration.Value = $T0F().Zero.MemberwiseClone();
    expr_143[4] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "texture";
    effectParameterDeclaration.Value = this.standardTex;
    expr_143[5] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "texmix";
    effectParameterDeclaration.Value = $T10().$Box(0);
    expr_143[6] = effectParameterDeclaration.MemberwiseClone();
    var shaderEffect = new ($T11())(expr_F7, $T12().$Cast(expr_143));
    var expr_286 = JSIL.Array.New($T0A(), 2);
    effectPassDeclaration = new ($T0A())();
    effectPassDeclaration.VS = this.toonVertexShader;
    effectPassDeclaration.PS = this.toonPixelShader;
    var expr_2B1 = new ($T0B())();
    expr_2B1.set_ZEnable(true);
    expr_2B1.set_CullMode($T0C().Clockwise);
    effectPassDeclaration.StateSet = expr_2B1;
    expr_286[0] = effectPassDeclaration.MemberwiseClone();
    effectPassDeclaration = new ($T0A())();
    effectPassDeclaration.VS = this.cellVertexShader;
    effectPassDeclaration.PS = this.cellPixelShader;
    var expr_2F7 = new ($T0B())();
    expr_2F7.set_ZEnable(true);
    expr_2F7.set_CullMode($T0C().Clockwise);
    effectPassDeclaration.StateSet = expr_2F7;
    expr_286[1] = effectPassDeclaration.MemberwiseClone();
    var expr_319 = JSIL.Array.New($T0E(), 9);
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "albedo";
    effectParameterDeclaration.Value = $T0F().One.MemberwiseClone();
    expr_319[0] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "shininess";
    effectParameterDeclaration.Value = $T10().$Box(1);
    expr_319[1] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "specfactor";
    effectParameterDeclaration.Value = $T10().$Box(1);
    expr_319[2] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "speccolor";
    effectParameterDeclaration.Value = $T0F().Zero.MemberwiseClone();
    expr_319[3] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "ambientcolor";
    effectParameterDeclaration.Value = $T0F().Zero.MemberwiseClone();
    expr_319[4] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "texture";
    effectParameterDeclaration.Value = this.standardTex;
    expr_319[5] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "texmix";
    effectParameterDeclaration.Value = $T10().$Box(0);
    expr_319[6] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "linecolor";
    effectParameterDeclaration.Value = $T13().Zero.MemberwiseClone();
    expr_319[7] = effectParameterDeclaration.MemberwiseClone();
    effectParameterDeclaration = new ($T0E())();
    effectParameterDeclaration.Name = "linewidth";
    effectParameterDeclaration.Value = $S03().CallStatic($T14(), "op_Multiply", null, $T14().One.MemberwiseClone(), 0.5);
    expr_319[8] = effectParameterDeclaration.MemberwiseClone();
    var shaderEffect2 = new ($T11())(expr_286, $T12().$Cast(expr_319));
    $thisType.addToShaderEffectDictionary("standard", shaderEffect);
    $thisType.addToShaderEffectDictionary("Tree.1", shaderEffect2);
    $thisType.addToShaderEffectDictionary("Tree.2", shaderEffect2);
    $thisType.addToShaderEffectDictionary("Tree.3", shaderEffect2);
    $thisType.addToShaderEffectDictionary("Tree.4", shaderEffect2);
    $thisType.addToShaderEffectDictionary("Tree.5", shaderEffect2);
    $thisType.addToShaderEffectDictionary("Tree", shaderEffect2);
    shaderEffect.AttachToContext(this.RC);
    shaderEffect2.AttachToContext(this.RC);
  }; 

  function Renderer_addToShaderEffectDictionary (key, shadereffect) {
    $thisType.shadereffects.Add(key, shadereffect);
  }; 

  function Renderer_addToTextureDictionary$00 (key, val) {
    $thisType.textures.Add(key, val);
  }; 

  function Renderer_addToTextureDictionary$01 (key, texture, rc) {
    $thisType.textures.Add(key, $thisType.createTexture(texture, rc));
  }; 

  function Renderer_createTexture (texture, rc) {
    var imgData = $T07().Get$b1($T16())(texture).MemberwiseClone();
    return rc.CreateTexture(imgData.MemberwiseClone(), false);
  }; 

  function Renderer_InitState () {
    (this._model).Clear();
    (this._model).set_Tos($T17().Identity.MemberwiseClone());
  }; 
  ...
  function Renderer_OnMaterial (material) {
    ...
    var flag = $thisType.shadereffects.TryGetValue(name, /* ref */ shaderEffect);
    if (flag) {
      var shaderEffect2 = shaderEffect.get();
    } else {
      shaderEffect2 = $thisType.shadereffects.get_Item("standard");
    }
    var hasDiffuse = material.get_HasDiffuse();
    if (hasDiffuse) {
      shaderEffect2.SetEffectParam("albedo", material.Diffuse.Color.MemberwiseClone());
      var flag2 = (material.Diffuse.Texture !== null) && 
      $thisType.textures.TryGetValue(material.Diffuse.Texture, /* ref */ value);
      if (flag2) {
        shaderEffect2.SetEffectParam("texture", value.get());
        shaderEffect2.SetEffectParam("texmix", $T10().$Box(1));
      } else {
        shaderEffect2.SetEffectParam("texmix", $T10().$Box(0));
      }
    } else {
      shaderEffect2.SetEffectParam("albedo", $T0F().Zero.MemberwiseClone());
    }
    var hasSpecular = material.get_HasSpecular();
    if (hasSpecular) {
      shaderEffect2.SetEffectParam("shininess", material.Specular.Shininess);
      shaderEffect2.SetEffectParam("specfactor", material.Specular.Intensity);
      shaderEffect2.SetEffectParam("speccolor", material.Specular.Color.MemberwiseClone());
    } else {
      shaderEffect2.SetEffectParam("shininess", $T1C().$Box(0));
      shaderEffect2.SetEffectParam("specfactor", $T1C().$Box(0));
      shaderEffect2.SetEffectParam("speccolor", $T0F().Zero.MemberwiseClone());
    }
    var hasEmissive = material.get_HasEmissive();
    if (hasEmissive) {
      shaderEffect2.SetEffectParam("ambientcolor", material.Emissive.Color.MemberwiseClone());
    } else {
      shaderEffect2.SetEffectParam("ambientcolor", $T0F().Zero.MemberwiseClone());
    }
  }; 
  ...
  function Renderer_OnMesh (mesh) {
    ...
    if (flag) {
      ...
      ($thisType.shadereffects.get_Item("standard")).RenderMesh(this.LookupMesh(mesh));
    }
  }; 

  function Renderer_OnTransform (xform) {
    this._model.Tos = $S04().CallStatic($T17(), "op_Multiply", null, this._model.Tos.MemberwiseClone(), $T1E().Matrix(xform).MemberwiseClone()).MemberwiseClone();
    (this.RC.ModelView = $S04().CallStatic($T17(), "op_Multiply", null, this.View.MemberwiseClone(), (this._model).get_Tos().MemberwiseClone()).MemberwiseClone());
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:true , Public:false}, "addToShaderEffectDictionary", 
      new JSIL.MethodSignature(null, [$.String, $asm04.TypeRef("Fusee.Engine.Core.ShaderEffect")]), 
      Renderer_addToShaderEffectDictionary
    );

    $.Method({Static:true , Public:true }, "addToTextureDictionary", 
      new JSIL.MethodSignature(null, [$.String, $asm03.TypeRef("Fusee.Engine.Common.ITexture")]), 
      Renderer_addToTextureDictionary$00
    );

    $.Method({Static:true , Public:true }, "addToTextureDictionary", 
      new JSIL.MethodSignature(null, [
          $.String, $.String, 
          $asm04.TypeRef("Fusee.Engine.Core.RenderContext")
        ]), 
      Renderer_addToTextureDictionary$01
    );

    $.Method({Static:true , Public:false}, "createTexture", 
      new JSIL.MethodSignature($asm03.TypeRef("Fusee.Engine.Common.ITexture"), [$.String, $asm04.TypeRef("Fusee.Engine.Core.RenderContext")]), 
    ...
    $.Field({Static:false, Public:true }, "_currentShader", $asm04.TypeRef("Fusee.Engine.Core.ShaderEffect"));
    ...
    $.Field({Static:true , Public:false}, "textures", $asm14.TypeRef("System.Collections.Generic.Dictionary`2", [$.String, $asm03.TypeRef("Fusee.Engine.Common.ITexture")]));

    $.Field({Static:true , Public:false}, "shadereffects", $asm14.TypeRef("System.Collections.Generic.Dictionary`2", [$.String, $asm04.TypeRef("Fusee.Engine.Core.ShaderEffect")]));

    $.Field({Static:false, Public:false}, "stdVertexShader", $.String);

    $.Field({Static:false, Public:false}, "stdPixelShader", $.String);

    $.Field({Static:false, Public:false}, "standardTex", $asm03.TypeRef("Fusee.Engine.Common.ITexture"));

    $.Field({Static:false, Public:false}, "toonVertexShader", $.String);

    $.Field({Static:false, Public:false}, "toonPixelShader", $.String);

    $.Field({Static:false, Public:false}, "standardTreeTex", $asm03.TypeRef("Fusee.Engine.Common.ITexture"));

    $.Field({Static:false, Public:false}, "cellPixelShader", $.String);

    $.Field({Static:false, Public:false}, "cellVertexShader", $.String);


    function Renderer__cctor () {
      $thisType.textures = $S00().Construct();
      $thisType.shadereffects = $S01().Construct();
    }; 
