...
(function DynamicWorld$Members () {
  ...
  function DynamicWorld_AddGImpactMeshShape (mesh) {
    ...
    var array2 = JSIL.Array.New($T05(), num2);
...
(function FontMap$Members () {
  ...
  function FontMap_FixTextKerning (vertices, text, scaleX) {
    ...
    if (flag) {
      ...
      for (var i = 0; i < (((text.length | 0) - 1) | 0); ) {
        ...
        var num3 = num2;
        num2 = ((num3 + 1) | 0);
        var var_5_64_cp_0_cp_1 = num3;
        vertices[var_5_64_cp_0_cp_1].x = +vertices[var_5_64_cp_0_cp_1].x + num;
        num3 = num2;
        num2 = ((num3 + 1) | 0);
        var var_5_83_cp_0_cp_1 = num3;
        vertices[var_5_83_cp_0_cp_1].x = +vertices[var_5_83_cp_0_cp_1].x + num;
        num3 = num2;
        num2 = ((num3 + 1) | 0);
        var var_5_A2_cp_0_cp_1 = num3;
        vertices[var_5_A2_cp_0_cp_1].x = +vertices[var_5_A2_cp_0_cp_1].x + num;
        num3 = num2;
        num2 = ((num3 + 1) | 0);
        var var_5_C1_cp_0_cp_1 = num3;
        vertices[var_5_C1_cp_0_cp_1].x = +vertices[var_5_C1_cp_0_cp_1].x + num;
        num3 = i;
        i = ((num3 + 1) | 0);
      }
      result = vertices;
  ...
  function FontMap_get_Image () {
    ...
    var num11 = new JSIL.BoxedVariable(0);
    ...
    if (uptodate) {
      ...
      image2.PixelData = JSIL.Array.New($T0F(), Math.imul(512, num7));
      ...
      for (var j = 0; j < (alphabet2.length | 0); j = ((j + 1) | 0)) {
        var c3 = (alphabet2[j]);
        var imageData = (this._font).RenderGlyph(c3.charCodeAt(0), /* ref */ num10, /* ref */ num11).MemberwiseClone();
        var flag2 = ((((num8 + (imageData.Width | 0)) | 0) + 1) | 0) >= 512;
        if (flag2) {
          num9 = ((num9 + num2) | 0);
          num2 = 0;
          num8 = 0;
        ...
        glyphOnMap.BitmapL = +(num10.get());
        glyphOnMap.BitmapT = +(num11.get());
        glyphOnMap.TexOffX = +((+num8 / 512));
        glyphOnMap.TexOffY = +((+num9 / +num4));
        ...
        num8 = ((num8 + (((imageData.Width | 0) + 1) | 0)) | 0);
      }
      this._uptodate = true;
  ...
  function Geometry_AddFace (vertInx, texCoordInx, normalInx) {
    ...
    if (texCoordInx !== null) {
      ...
      for (i = 0; i < (texCoordInx.length | 0); ) {
        ...
        if (flag5) {
          throw $S02().Construct(JSIL.ConcatString("Texture coordinate index out of range: ", $T04().$Box(num3)), JSIL.ConcatString("texCoordInx[", $T04().$Box(i), "]"));
        }
    ...
    if (normalInx !== null) {
      ...
      for (i = 0; i < (normalInx.length | 0); ) {
        ...
        if (flag8) {
          throw $S02().Construct(JSIL.ConcatString("Normal index out of range: ", $T04().$Box(num4)), JSIL.ConcatString("normalInx[", $T04().$Box(i), "]"));
        }
...
(function Input$Members () {
  ...
  function Input_Dispose () {
    ...
    while ($T18().prototype.MoveNext.call(enumerator)) {
      ...
      if (expr_24 !== null) {
        var deviceConnectionArgs = new ($T1A())();
        deviceConnectionArgs.InputDevice = current;
        expr_24(this, deviceConnectionArgs);
      }
      current.Disconnect();
    }
  ...
  function Input_OnDeviceImpDisconnected (sender, args) {
    ...
    if (flag3) {
      ...
      if (expr_99 !== null) {
        var deviceConnectionArgs = new ($T1A())();
        deviceConnectionArgs.InputDevice = inputDevice.get();
        expr_99(this, deviceConnectionArgs);
      }
      return;
    }
  ...
  function Input_OnNewDeviceImpConnected (sender, args) {
    ...
    if (expr_C4 !== null) {
      var deviceConnectionArgs = new ($T1A())();
      deviceConnectionArgs.InputDevice = inputDevice.get();
      expr_C4(this, deviceConnectionArgs);
    }
  }; 
  ...
  function Input_RegisterInputDeviceType (match, creator) {
    ...
    var specialDeviceCreator = new ($T16())();
    specialDeviceCreator.Match = match;
    specialDeviceCreator.Creator = creator;
    $S0F().CallVirtual("Add", null, this._specialDeviceCreators, specialDeviceCreator);
    ...
    for (var a$0 = list._items, i$0 = 0, l$0 = (list._size | 0); i$0 < l$0; ($temp00 = i$0, 
      ...
      var expr_EA = this.InputDeviceDisconnected;
      if (expr_EA !== null) {
        var deviceConnectionArgs = new ($T1A())();
        deviceConnectionArgs.InputDevice = inputDevice;
        expr_EA(this, deviceConnectionArgs);
      }
      ...
      var expr_140 = this.InputDeviceConnected;
      if (expr_140 !== null) {
        deviceConnectionArgs = new ($T1A())();
        deviceConnectionArgs.InputDevice = inputDevice;
        expr_140(this, deviceConnectionArgs);
      }
    }
  }; 
...
(function InputDevice$Members () {
  ...
  function InputDevice__ctor (inpDeviceImp) {
    ...
    var nextAxisId = (this._nextAxisId | 0);
    this._nextAxisId = ((nextAxisId + 1) | 0);
  ...
  function InputDevice_Disconnect () {
    ...
    for (var i = 0; i < (array.length | 0); i = ((i + 1) | 0)) {
      ...
      if (flag) {
        var arg_71_0 = this.AxisValueChanged;
        var axisValueChangedArgs = new ($T18())();
        axisValueChangedArgs.Axis = (this._axes).get_Item(key).MemberwiseClone();
        axisValueChangedArgs.Value = 0;
        arg_71_0(this, axisValueChangedArgs);
      }
    ...
    for (var k = 0; k < (array3.length | 0); k = ((k + 1) | 0)) {
      ...
      if (flag2) {
        var arg_142_0 = this.ButtonValueChanged;
        var buttonValueChangedArgs = new ($T19())();
        buttonValueChangedArgs.Button = (this._buttons).get_Item(key3).MemberwiseClone();
        buttonValueChangedArgs.Pressed = false;
        arg_142_0(this, buttonValueChangedArgs);
      }
  ...
  function InputDevice_PreRender () {
    ...
    if (this.AxisValueChanged !== null) {
      ...
      for (var i = 0; i < (array.length | 0); i = ((i + 1) | 0)) {
        ...
        if (flag4) {
          var arg_11A_0 = this.AxisValueChanged;
          var axisValueChangedArgs = new ($T18())();
          axisValueChangedArgs.Axis = (this._axes).get_Item(num).MemberwiseClone();
          axisValueChangedArgs.Value = +num2.get();
          arg_11A_0(this, axisValueChangedArgs);
    ...
    for (var j = 0; j < (array2.length | 0); j = ((j + 1) | 0)) {
      ...
      if (flag5) {
        ...
        var expr_1BD = this.ButtonValueChanged;
        if (expr_1BD !== null) {
          var buttonValueChangedArgs = new ($T19())();
          buttonValueChangedArgs.Button = (this._buttons).get_Item(num3).MemberwiseClone();
          buttonValueChangedArgs.Pressed = button;
          expr_1BD(this, buttonValueChangedArgs);
        }
    ...
    while ($T23().prototype.MoveNext.call(enumerator2)) {
      ...
      var expr_2AB = this.ButtonValueChanged;
      if (expr_2AB !== null) {
        buttonValueChangedArgs = new ($T19())();
        buttonValueChangedArgs.Button = (this._buttons).get_Item(current2.get_Key()).MemberwiseClone();
        buttonValueChangedArgs.Pressed = current2.get_Value();
        expr_2AB(this, buttonValueChangedArgs);
      }
    }
  ...
  function InputDevice_RegisterCalculatedAxis (calculatedAxisDescription, calculator, initialValue) {
    ...
    var calculatedAxisDescription2 = new ($T26())();
    calculatedAxisDescription2.AxisDesc = calculatedAxisDescription.MemberwiseClone();
    calculatedAxisDescription2.CurrentAxisValue = +initialValue;
    calculatedAxisDescription2.Calculator = calculator;
    var calculatedAxisDescription3 = calculatedAxisDescription2;
    (this._calculatedAxes).set_Item(calculatedAxisDescription.Id, calculatedAxisDescription3);
    (this._axesToPoll).set_Item(calculatedAxisDescription.Id, calculatedAxisDescription3.CurrentAxisValue);
...
(function $l$gc$Members () {
  ...
  function $l$gc_$l_ctor$gb__52_0 (obj, eventArgs) {
  }; 
...
(function SceneRenderer$Members () {
  ...
  function SceneRenderer_MakeMesh (mc) {
    ...
    if (weights === null) {
      ...
      for (var i = 0; i < ((weights.WeightMap).get_Count() | 0); ) {
        ...
        if (flag3) {
          var arg_F2_0 = vertexWeightList;
          var expr_C8 = JSIL.Array.New($T45(), 1);
          var vertexWeight = new ($T45())();
          vertexWeight.JointIndex = 0;
          vertexWeight.Weight = 1;
          expr_C8[0] = vertexWeight.MemberwiseClone();
          arg_F2_0.VertexWeightList$VertexWeights$value = $S12().Construct($T47().$Cast(expr_C8));
        }
  ...
  function SceneRenderer_RenderWeight (weight) {
    ...
    for (var i = 0; i < ($S15().CallStatic($T4F(), "Count$b1", [$asm07.Fusee.Serialization.SceneNodeContainer], weight.Joints) | 0); ) {
...
(function RenderCanvas$Members () {
  ...
  function RenderCanvas_$lInitCanvas$gb__31_0 (obj, initEventArgs) {
    this.Init();
  }; 

  function RenderCanvas_$lInitCanvas$gb__31_1 (obj, initEventArgs) {
    this.DeInit();
  }; 

  function RenderCanvas_$lInitCanvas$gb__31_2 (obj, renderEventArgs) {
  ...
  function RenderCanvas_$lInitCanvas$gb__31_3 (obj, resizeEventArgs) {
    this.Resize();
  }; 
...
(function Time$Members () {
  ...
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm14.System.Int64)) ();
  };
...
(function TouchDevice$Members () {
  ...
  function TouchDevice__ctor (inpDeviceImp) {
    ...
    for (var i = 0; i < num; ) {
      ...
      var num3 = num2;
      num2 = ((num3 + 1) | 0);
      this._velocityIDs[arg_77_1] = (this.RegisterVelocityAxis(
        num3, 
        1, 
        0, 
        null, 
      ...
      num3 = num2;
      num2 = ((num3 + 1) | 0);
      this._velocityIDs[arg_A3_1] = (this.RegisterVelocityAxis(
        num3, 
        1, 
        0, 
        null, 
  ...
  function TouchDevice_$lRegisterTtpAngleAxis$gb__10_0 (num) {
    ...
    if (flag) {
      ...
      var num2 = Math.fround(Math.atan2(-float.y, float.x));
      result = num2;
    }
    return result;
  }; 

  function TouchDevice_$lRegisterTtpDistanceAxis$gb__11_0 (num) {
    var flag = !this.get_TwoPoint();
    if (flag) {
      var result = 0;
    } else {
...
(function $l$gc__DisplayClass12_0$Members () {
  ...
  function $l$gc__DisplayClass12_0_$lRegisterTtpMidpointAxis$gb__0 (num) {
...
(function GUIElement$Members () {
  ...
  function GUIElement_CreateTextShader (textAtlas) {
    ...
    effectPassDeclaration.StateSet = renderStateSet;
    expr_08[0] = effectPassDeclaration.MemberwiseClone();
    var expr_66 = JSIL.Array.New($T11(), 2);
    ...
    this.TextShader = new ($T05())(expr_08, $T12().$Cast(expr_66));
  }; 
    ...
    if (this.FontMap !== null) {
      ...
      for (var i = 0; i < (text.length | 0); i = ((i + 1) | 0)) {
        ...
        if (!((num9 <= 1.192093E-07) || (num10 <= 1.192093E-07))) {
          ...
          var arg_276_0 = array3;
          var num11 = num5;
          num5 = ((num11 + 1) | 0);
          arg_276_0[num11] = (((num6 + 1) >>> 0) & 0xFFFF);
          var arg_287_0 = array3;
          num11 = num5;
          num5 = ((num11 + 1) | 0);
          arg_287_0[num11] = num6;
          var arg_29B_0 = array3;
          num11 = num5;
          num5 = ((num11 + 1) | 0);
          arg_29B_0[num11] = (((num6 + 2) >>> 0) & 0xFFFF);
          var arg_2AF_0 = array3;
          num11 = num5;
          num5 = ((num11 + 1) | 0);
          arg_2AF_0[num11] = (((num6 + 1) >>> 0) & 0xFFFF);
          var arg_2C3_0 = array3;
          num11 = num5;
          num5 = ((num11 + 1) | 0);
          arg_2C3_0[num11] = (((num6 + 2) >>> 0) & 0xFFFF);
          var arg_2D7_0 = array3;
          num11 = num5;
          num5 = ((num11 + 1) | 0);
          arg_2D7_0[num11] = (((num6 + 3) >>> 0) & 0xFFFF);
  ...
  function GUIButton_OnMouseButton (sender, bvca) {
    ...
    if (flag) {
      ...
      if (pressed) {
        ...
        if (expr_1E !== null) {
          var gUIButtonEventArgs = new ($T13())();
          gUIButtonEventArgs.mouseX = ($T0C().get_Mouse().get_PositionInt().x | 0);
          gUIButtonEventArgs.mouseY = ($T0C().get_Mouse().get_PositionInt().y | 0);
          expr_1E(this, gUIButtonEventArgs);
        }
      } else {
        var expr_64 = this.OnGUIButtonUp;
        if (expr_64 !== null) {
          gUIButtonEventArgs = new ($T13())();
          gUIButtonEventArgs.mouseX = ($T0C().get_Mouse().get_PositionInt().x | 0);
          gUIButtonEventArgs.mouseY = ($T0C().get_Mouse().get_PositionInt().y | 0);
          expr_64(this, gUIButtonEventArgs);
        }
      }
    }
  }; 
    ...
    if (flag) {
      ...
      if (!mouseOnButton) {
        ...
        if (this.OnGUIButtonEnter !== null) {
          var arg_6C_0 = this.OnGUIButtonEnter;
          var gUIButtonEventArgs = new ($T13())();
          gUIButtonEventArgs.mouseX = ($T0C().get_Mouse().get_PositionInt().x | 0);
          gUIButtonEventArgs.mouseY = ($T0C().get_Mouse().get_PositionInt().y | 0);
          arg_6C_0(this, gUIButtonEventArgs);
        }
      }
    } else {
      if (this._mouseOnButton) {
        ...
        if (this.OnGUIButtonLeave !== null) {
          var arg_D7_0 = this.OnGUIButtonLeave;
          gUIButtonEventArgs = new ($T13())();
          gUIButtonEventArgs.mouseX = ($T0C().get_Mouse().get_PositionInt().x | 0);
          gUIButtonEventArgs.mouseY = ($T0C().get_Mouse().get_PositionInt().y | 0);
          arg_D7_0(this, gUIButtonEventArgs);
        }
      }
    }
  }; 
  ...
  function GUIPanel_OnMouseButton (sender, bvca) {
    ...
    if (flag) {
      ...
      if (pressed) {
        ...
        if (expr_1E !== null) {
          var gUIPanelEventArgs = new ($T10())();
          gUIPanelEventArgs.mouseX = ($T0C().get_Mouse().get_PositionInt().x | 0);
          gUIPanelEventArgs.mouseY = ($T0C().get_Mouse().get_PositionInt().y | 0);
          expr_1E(this, gUIPanelEventArgs);
        }
      } else {
        var expr_64 = this.OnGUIPanelUp;
        if (expr_64 !== null) {
          gUIPanelEventArgs = new ($T10())();
          gUIPanelEventArgs.mouseX = ($T0C().get_Mouse().get_PositionInt().x | 0);
          gUIPanelEventArgs.mouseY = ($T0C().get_Mouse().get_PositionInt().y | 0);
          expr_64(this, gUIPanelEventArgs);
        }
      }
    }
  }; 
    ...
    if (flag) {
      ...
      if (!mouseOnPanel) {
        ...
        if (this.OnGUIPanelEnter !== null) {
          var arg_6C_0 = this.OnGUIPanelEnter;
          var gUIPanelEventArgs = new ($T10())();
          gUIPanelEventArgs.mouseX = ($T0C().get_Mouse().get_PositionInt().x | 0);
          gUIPanelEventArgs.mouseY = ($T0C().get_Mouse().get_PositionInt().y | 0);
          arg_6C_0(this, gUIPanelEventArgs);
        }
      }
    } else {
      if (this._mouseOnPanel) {
        ...
        if (this.OnGUIPanelLeave !== null) {
          var arg_D7_0 = this.OnGUIPanelLeave;
          gUIPanelEventArgs = new ($T10())();
          gUIPanelEventArgs.mouseX = ($T0C().get_Mouse().get_PositionInt().x | 0);
          gUIPanelEventArgs.mouseY = ($T0C().get_Mouse().get_PositionInt().y | 0);
          arg_D7_0(this, gUIPanelEventArgs);
        }
      }
    }
  }; 
