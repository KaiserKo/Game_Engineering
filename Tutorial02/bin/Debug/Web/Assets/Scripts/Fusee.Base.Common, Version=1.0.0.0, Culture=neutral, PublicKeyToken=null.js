...
(function $l$gc__DisplayClass14_1$Members () {
  ...
  function $l$gc__DisplayClass14_1_$lBlt$gb__6 (idl, isl) {
    ...
    for (var i = 0; i < (this.CS$$l$g8__locals1.width | 0); ) {
...
(function Path$Members () {
  ...
  function Path_CleanPath (s) {
    ...
    if ((length === 1) && (((c.charCodeAt(0) | 0) === ($thisType.DirectorySeparatorChar.charCodeAt(0) | 0)) || 
      ...
      if (flag6) {
        ...
        for (var num4 = num2; (j < length) && (num4 < (array.length | 0)); ) {
          var c3 = (s[j]);
          ...
          if (flag8) {
            ...
            var flag9 = ((num4 + 1) | 0) !== (array.length | 0);
            if (flag9) {
              var arg_191_0 = array;
              num3 = num4;
              num4 = ((num3 + 1) | 0);
              arg_191_0[num3] = $thisType.DirectorySeparatorChar;
          ...
          if (flag5) {
            ...
            if (flag6) {
              ...
              if (flag7) {
                ...
                while ((num < (path.length | 0)) && !$thisType.IsDirectorySeparator(path[num])) {
                  var num2 = num;
                  num = ((num2 + 1) | 0);
                }
                ...
                if (flag8) {
                  ...
                  for (num = ((num2 + 1) | 0); (num < (path.length | 0)) && !$thisType.IsDirectorySeparator(path[num]); ) {
                    num2 = num;
                    num = ((num2 + 1) | 0);
                  }
                }
  ...
  function Path_GetServerAndShare (path) {
    ...
    for (var num = 2; (num < (path.length | 0)) && !$thisType.IsDirectorySeparator(path[num]); ) {
      var num2 = num;
      num = ((num2 + 1) | 0);
    }
  ...
  function Path_IsPathSubsetOf (subset, path) {
    ...
    if (flag) {
      ...
      if (flag2) {
        ...
        var num2 = num;
        num = ((num2 + 1) | 0);
        var num3 = (System.String.IndexOfAny(path, $thisType.PathSeparatorChars, num));
        var flag3 = num3 >= num;
        if (flag3) {
          result = ($T01().Compare(
            subset, 
