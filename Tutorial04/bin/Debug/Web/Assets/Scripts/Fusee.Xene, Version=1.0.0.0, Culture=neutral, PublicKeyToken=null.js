...
(function SceneFinderExtensions$Members () {
  ...
  function SceneFinderExtensions_FindComponents$00 (root, match) {
    ...
    sceneComponentEnumerable._rootList = $T03().SingleRootEnumerator(root);
    return sceneComponentEnumerable;
  }; 

  function SceneFinderExtensions_FindComponents$b1$01 (TComponent, root, match) {
    var sceneComponentEnumerable = new ($asm0B.Fusee.Xene.SceneFinderExtensions_SceneComponentEnumerable$b1.Of(TComponent)) ();
    sceneComponentEnumerable._match = match;
    sceneComponentEnumerable._rootList = $T03().SingleRootEnumerator(root);
    return sceneComponentEnumerable;
  }; 
  ...
  function SceneFinderExtensions_FindNodes$04 (root, match) {
    ...
    sceneNodeEnumerable._rootList = $T03().SingleRootEnumerator(root);
    return sceneNodeEnumerable;
  }; 

  function SceneFinderExtensions_FindNodes$b1$05 (TNode, root, match) {
    var sceneNodeEnumerable = new ($asm0B.Fusee.Xene.SceneFinderExtensions_SceneNodeEnumerable$b1.Of(TNode)) ();
    sceneNodeEnumerable._match = match;
    sceneNodeEnumerable._rootList = $T03().SingleRootEnumerator(root);
    return sceneNodeEnumerable;
  }; 
  ...
  function SceneFinderExtensions_FindNodesWhereComponent$08 (root, match) {
    ...
    sceneNodeWhereComponentEnumerable._rootList = $T03().SingleRootEnumerator(root);
  ...
  function SceneFinderExtensions_FindNodesWhereComponent$b1$09 (TComponent, root, match) {
    var sceneNodeWhereComponentEnumerable = new ($asm0B.Fusee.Xene.SceneFinderExtensions_SceneNodeWhereComponentEnumerable$b2.Of($asm07.Fusee.Serialization.SceneNodeContainer, TComponent)) ();
    sceneNodeWhereComponentEnumerable._match = match;
    sceneNodeWhereComponentEnumerable._rootList = $T03().SingleRootEnumerator(root);
    return sceneNodeWhereComponentEnumerable;
  }; 
  ...
  function SceneFinderExtensions_FindNodesWhereComponent$b2$0A (TNode, TComponent, root, match) {
    var sceneNodeWhereComponentEnumerable = new ($asm0B.Fusee.Xene.SceneFinderExtensions_SceneNodeWhereComponentEnumerable$b2.Of(TNode, TComponent)) ();
    sceneNodeWhereComponentEnumerable._match = match;
    sceneNodeWhereComponentEnumerable._rootList = $T03().SingleRootEnumerator(root);
    return sceneNodeWhereComponentEnumerable;
  }; 
...
(function ViseratorExtensions$Members () {
  ...
  function ViseratorExtensions_Viserate$b2$00 (TViserator, TResult, root) {
    var viseratorEnumerable = new ($asm0B.Fusee.Xene.ViseratorExtensions_ViseratorEnumerable$b2.Of(TViserator, TResult)) ();
    viseratorEnumerable._rootList = $T02().SingleRootEnumerator(root);
